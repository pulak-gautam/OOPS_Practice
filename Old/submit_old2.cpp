...
public:
    ...
    void listTravellers()
    {
        // std::cout << "HELLLLLLLLLLLLLLLLLLLLLLLLLLLLL";
        std::cout << "\n" << this->travelList.size() << std::endl;
        this->travelList.resize(2);
        std::cout << "\n-----+-----+-----\n";
        std::cout << "Passengers:-";
        ...
        std::cout << "Astronaut:-\n";
        std::cout << "Name : ";
        (*(this->astronaut)).getName();
        std::cout << "ID : ";
        (*(this->astronaut)).getId();

        std::cout << "Commander:-\n";
        std::cout << "Name : ";
        (*(this->commander)).getName();
        std::cout << "ID : ";
...
std::map<int, std::vector<spaceTravel* >> spaceTravel::travels;
...
void Ticket::bookTicket(Planet s, Planet d, Passenger *p)
{
    ...
    if (Ticket::ticketList[travelDate].size() == 1)
    {
        ...
        s.travelList.reserve(2000);

        spaceTravel::travels[travelDate].push_back(&s);
        std::cout << "intial size " << ((spaceTravel::travels[21032023])[0])->travelList.size();
        // std::cout << "hello";
        ((spaceTravel::travels[21032023])[0])->listTravellers();
        std::cout << "\n\nin size " << ((spaceTravel::travels[21032023])[0])->travelList.size();
    }
...
int main()
{
    ...
    // s.addTraveller(&p);
    // std::cout << s.travelList.size() << std::endl;
    // s.listTravellers();
    // std::cout << "\n-----+-----+-----";
    ...
    Ticket::bookTicket(mars, moon, &p1);

    // std::cout << spaceTravel::travels[21032023].size() << std::endl;
    ((spaceTravel::travels[21032023])[0]);
}
